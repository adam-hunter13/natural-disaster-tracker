...
To prevent any billing to my account, I have closed my API credentials. Because of this, no map will populate with my hosted site. To fix this, simply sign up for your own Google Maps API and replace my key with yours in the Map.js component.
